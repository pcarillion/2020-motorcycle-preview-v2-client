        ...
        <div className='auth-div'>
            ...
            <form>
                <div className="inputs">
                    ...
                    <input type="text" name="mail" className="text-input" placeholder="Email"/>
