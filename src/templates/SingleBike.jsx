...
const SingleBike = (props) => {
  ...
  return (
    <div className="one-bike-div">
      <BikeBanner bikeName={`${bike.brand} ${bike.name}`} />
        ...
        <div>
          ...
          <table className="details-table">
            <tbody>
              ...
              <tr>
                <td>A2</td>
                <td>{bike.A2 ? "Available" : "Not available"}</td>
              </tr>
            </tbody>
          </table>
          <p>
            <Link to={`${bike.link}`}>See more on the brand's website</Link>
          </p>
          ...
          <div className="gallery">
            {bike.gallery &&
              bike.gallery.map((pic, i) => {
                return (
                  <img
                    src={pic}
                    alt=""
                    class="photo-in-the-gallery"
      ...
      {isOpen && (
        <button type="button" onClick={togglePic} className="close">
          X
        </button>
      )}
